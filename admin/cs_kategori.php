        ...
        <div class="row">
                        ...
                        <tbody>
                            ...
                            <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="badge badge-danger" href="cs_edt_kategori.php?id=<?php echo $pecah['id_kategori']; ?>">edit</a>
                                        <a class="badge badge-warning" onclick="return confirm('Apakah Anda yakin ingin menghapus ini ?')" href="cs_hps_kategori.php?id=<?php echo $pecah['id_kategori']; ?>">hapus</a>
                                    </td>
                                </tr>
                                <?php $nomor++; ?>
                            <?php } ?>
            ...
            <div class="col-md-6">
                <div class="card card-login mx-auto mt-6">
                    ...
                    <div class="card-body">
                        <form role="form" method="post" action="add_cs/kategori.php">
                            <div class="box-body">
