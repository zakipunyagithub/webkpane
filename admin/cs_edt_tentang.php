...
<?php //include("../templates/cs_sidebar.php"); ?>
...
if (isset($_POST['ubah'])) {
    ...
    echo "<script>location='cs_tentang.php';</script>";
}
?>
...
//     $koneksi->query("UPDATE tentang SET tentang_toko='$_POST[nama]',alamat='$_POST[alamat]',no_tlp='$_POST[notlp]',maps='$_POST[maps]' WHERE id_toko='$_GET[id]'");
