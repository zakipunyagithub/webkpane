                        ...
                        <tbody>
                            ...
                            <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="badge badge-danger" href="karyawan_edit_bahan_jamu.php?id=<?php echo $pecah['id']; ?>">edit</a>
                                        <a class="badge badge-warning" onclick="return confirm('Apakah Anda yakin ingin menghapus ini ?')" href="karyawan_hapus_bahan_jamu.php?id=<?php echo $pecah['id']; ?>">hapus</a>
                                    </td>
                                </tr>
                                <?php $nomor++; ?>
                            <?php } ?>
...
if (isset($_POST['save'])) {
    ...
    if (mysqli_query($koneksi, $query)) {
        echo "<meta http-equiv='refresh' content='1;url=karyawan_bahan_jamu.php'>";
    } else {
        echo "<meta http-equiv='refresh' content='1;url=karyawan_bahan_jamu.php'>";
    }
}
