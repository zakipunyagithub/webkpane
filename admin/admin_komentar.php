                ...
                <tbody>
                    ...
                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="badge badge-warning" onclick="return confirm('Apakah Anda yakin ingin menghapus ini ?')" href="admin_hps_komentar.php?id=<?php echo $pecah['id_pesan']; ?>">hapus</a>
                            </td>
                        </tr>
                        <?php $nomor++; ?>
                    <?php } ?>
