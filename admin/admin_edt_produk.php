...
if (isset($_POST['ubah'])) {
    ...
    if (!empty($lokasifoto)) {
        ...
        $koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]',id_kategori='$_POST[id_kategori]',harga_produk='$_POST[harga]',deskripsi_produk='$_POST[deskripsi]',foto_produk='$namafoto',link_produk='$_POST[link_produk]' WHERE id_produk='$_GET[id]'");
    } else {
        $koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]',id_kategori='$_POST[id_kategori]',harga_produk='$_POST[harga]',deskripsi_produk='$_POST[deskripsi]',foto_produk='$namafoto',link_produk='$_POST[link_produk]' WHERE id_produk='$_GET[id]'");
    }
